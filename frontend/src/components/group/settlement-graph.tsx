...
export function SettlementGraph({ suggestions, nameOf }: SettlementGraphProps) {
    ...
    <div className="space-y-3">
      ...
      <div className="grid gap-3 sm:grid-cols-2">
        {suggestions.map((s, i) => (
          <div
            key={i}
            className="group relative flex items-center justify-between gap-3 rounded-2xl border border-border/40 bg-card p-4 shadow-premium transition-all duration-300 hover:shadow-lg hover:border-brand/30"
          >
